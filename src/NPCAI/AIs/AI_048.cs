...
partial class AIs
{
    public static void AI_048(this NPC npc)
    {
        ...
        if (npc.ai[1] >= num737)
        {
            ...
            if (Main.netMode != 1)
            {
                _ = Projectile.NewProjectile(npc.GetSpawnSource_ForProjectile(), vector93.X, vector93.Y, num741, num742, num740, num739, 0f, Main.myPlayer);
            }
        }
        float num745 = num730;
        npc.ai[2] += num745;
        ...
        if (npc.ai[2] > 100 + Main.rand.Next(4800))
        {
            ...
            for (int num746 = 0; num746 < 2; num746++)
            {
                ...
                if (Main.netMode != 1)
                {
                    int num753 = Projectile.NewProjectile(npc.GetSpawnSource_ForProjectile(), vector94.X, vector94.Y, num750, num751, num749, num748, 0f, Main.myPlayer);
