...
{
    public const ushort PacketLength = sizeof(ushort);
    public const ushort PacketType = sizeof(byte);
    public const ushort PacketHead = PacketLength + PacketType;
