                ...
                else
                {
                    ...
                    if (npc.ai[3] >= 60f)
                    {
                        ...
                        if (Main.netMode != 1)
                        {
                            ...
                            Projectile.NewProjectile(npc.GetSpawnSource_ForProjectile(), vector49.X, vector49.Y, num455, num456, num461, attackDamage_ForProjectiles6, 0f, Main.myPlayer);
                        }
                    }
                }
            }
            ...
            if (Collision.CanHit(npc.position, npc.width, npc.height, Main.player[npc.target].position, Main.player[npc.target].width, Main.player[npc.target].height))
            {
                ...
                if (Main.netMode != 1)
                {
                    ...
                    if (npc.localAI[1] > 8f)
                    {
                        ...
                        _ = Projectile.NewProjectile(npc.GetSpawnSource_ForProjectile(), vector51.X, vector51.Y, num472, num473, num477, attackDamage_ForProjectiles7, 0f, Main.myPlayer);
                    }
                }
            }
            if (NPC.IsMechQueenUp)
